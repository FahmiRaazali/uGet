...
//	gtk_image_menu_item_set_image ((GtkImageMenuItem*)menu_item, image);
	...
	image = gtk_image_new_from_icon_name ("media-playback-start-symbolic", GTK_ICON_SIZE_SMALL_TOOLBAR);
	tool_item = (GtkToolItem*) gtk_tool_button_new (image, NULL);
	...
	image = gtk_image_new_from_icon_name ("document-properties-symbolic", GTK_ICON_SIZE_SMALL_TOOLBAR);
	tool_item = (GtkToolItem*) gtk_tool_button_new (image, NULL);
