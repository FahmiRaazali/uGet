...
// UgtkFileMenu
static void
ugtk_menubar_file_init(UgtkMenubar* menubar, GtkAccelGroup* accel_group)
{
    GtkWidget* menu;
    GtkWidget* submenu;
    GtkWidget* menu_item;
    ...
    // New Category
    menu_item = gtk_menu_item_new_with_mnemonic(_("New _Category..."));
    gtk_menu_shell_append((GtkMenuShell*) menu, menu_item);
    ...
    menu_item = gtk_menu_item_new_with_mnemonic(_("_Batch Downloads"));
    ...
    menu_item = gtk_menu_item_new_with_mnemonic(_("_Clipboard batch..."));
    ...
    menu_item = gtk_menu_item_new_with_mnemonic(_("_URL Sequence batch..."));
    gtk_menu_shell_append((GtkMenuShell*) submenu, menu_item);
    menubar->file.batch.sequence = menu_item;
    // Batch downloads - Text file import (.txt)
    menu_item = gtk_menu_item_new_with_mnemonic(_("_Text file import (.txt)..."));
    gtk_menu_shell_append((GtkMenuShell*) submenu, menu_item);
    menubar->file.batch.text_import = menu_item;
    // Batch downloads - HTML file import (.html)
    menu_item = gtk_menu_item_new_with_mnemonic(_("_HTML file import (.html)..."));
    gtk_menu_shell_append((GtkMenuShell*) submenu, menu_item);
    menubar->file.batch.html_import = menu_item;
    // Batch downloads - separator
    gtk_menu_shell_append((GtkMenuShell*) submenu, gtk_separator_menu_item_new());
    // Batch downloads - Export to Text file (.txt)
    menu_item = gtk_menu_item_new_with_mnemonic(_("_Export to Text file (.txt)..."));
    gtk_menu_shell_append((GtkMenuShell*) submenu, menu_item);
...
static void
ugtk_menubar_edit_init(UgtkMenubar* menubar)
{
    GtkWidget* menu;
    GtkWidget* submenu;
    GtkWidget* menu_item;
    ...
    menu_item = gtk_menu_item_new_with_mnemonic(_("Completion _Auto-Actions"));
    submenu = gtk_menu_new();
    //	gtk_menu_set_accel_group ((GtkMenu*)submenu, accel_group);
    gtk_menu_item_set_submenu((GtkMenuItem*) menu_item, submenu);
    gtk_menu_shell_append((GtkMenuShell*) menu, menu_item);
    ...
    menu_item = gtk_radio_menu_item_new_with_mnemonic_from_widget((GtkRadioMenuItem*) menu_item,
                                                                  _("Hibernate"));
    gtk_menu_shell_append((GtkMenuShell*) submenu, menu_item);
...
static void
ugtk_menubar_view_init(UgtkMenubar* menubar)
{
    GtkWidget* menu;
    GtkWidget* submenu;
    GtkWidget* menu_item;
...
static void
ugtk_menubar_category_init(UgtkMenubar* menubar)
{
    GtkWidget* menu;
    GtkWidget* menu_item;
    ...
    // New Category
    menu_item = gtk_menu_item_new_with_mnemonic(_("_New Category..."));
    gtk_menu_shell_append((GtkMenuShell*) menu, menu_item);
    menubar->category.create = menu_item;
    // Delete Category
    menu_item = gtk_menu_item_new_with_mnemonic(_("_Delete Category"));
    gtk_menu_shell_append((GtkMenuShell*) menu, menu_item);
    menubar->category.delete = menu_item;
    // Properties
    menu_item = gtk_menu_item_new_with_mnemonic(_("Properties"));
    gtk_menu_shell_append((GtkMenuShell*) menu, menu_item);
    menubar->category.properties = menu_item;

    gtk_menu_shell_append((GtkMenuShell*) menu, gtk_separator_menu_item_new());
    // Move Up
    menu_item = gtk_menu_item_new_with_mnemonic(_("Move _Up"));
    gtk_menu_shell_append((GtkMenuShell*) menu, menu_item);
...
// UgtkDownloadMenu
static void
ugtk_menubar_download_init(UgtkMenubar* menubar, GtkAccelGroup* accel_group)
{
    GtkWidget* menu;
    GtkWidget* submenu;
    GtkWidget* menu_item;
    ...
    menu_item = gtk_menu_item_new_with_mnemonic(_("New Download..."));
    gtk_menu_shell_append((GtkMenuShell*) menu, menu_item);
    menubar->download.create = menu_item;

    menu_item = gtk_menu_item_new_with_mnemonic(_("_Delete Entry"));
    gtk_menu_item_set_accel_path((GtkMenuItem*) menu_item, UGTK_APP_ACCEL_PATH_DELETE);
    gtk_menu_shell_append((GtkMenuShell*) menu, menu_item);
    menubar->download.delete = menu_item;

    menu_item = gtk_menu_item_new_with_mnemonic(_("Delete Entry and _File"));
    ...
    menu_item = gtk_menu_item_new_with_mnemonic(_("Open"));
    gtk_menu_item_set_accel_path((GtkMenuItem*) menu_item, UGTK_APP_ACCEL_PATH_OPEN);
    gtk_menu_shell_append((GtkMenuShell*) menu, menu_item);
    menubar->download.open = menu_item;
    gtk_widget_hide(menu_item);

    menu_item = gtk_menu_item_new_with_mnemonic(_("Open _Containing folder"));
    ...
    menu_item = gtk_menu_item_new_with_mnemonic(_("Force Start"));
    gtk_menu_shell_append((GtkMenuShell*) menu, menu_item);
    menubar->download.force_start = menu_item;

    menu_item = gtk_menu_item_new_with_mnemonic(_("_Runnable"));
    gtk_menu_item_set_accel_path((GtkMenuItem*) menu_item, UGTK_APP_ACCEL_PATH_SWITCH);
    gtk_menu_shell_append((GtkMenuShell*) menu, menu_item);
    menubar->download.runnable = menu_item;

    menu_item = gtk_menu_item_new_with_mnemonic(_("P_ause"));
    gtk_menu_item_set_accel_path((GtkMenuItem*) menu_item, UGTK_APP_ACCEL_PATH_SWITCH);
    gtk_menu_shell_append((GtkMenuShell*) menu, menu_item);
    ...
    // Move to --- start ---
    menu_item = gtk_menu_item_new_with_mnemonic(_("_Move To"));
    gtk_menu_shell_append((GtkMenuShell*) menu, menu_item);
    ...
    // Priority - High
    menu_item = gtk_radio_menu_item_new_with_mnemonic(NULL, _("_High"));
    gtk_menu_shell_append((GtkMenuShell*) submenu, menu_item);
    ...
    // Priority - Low
    menu_item =
        gtk_radio_menu_item_new_with_mnemonic_from_widget((GtkRadioMenuItem*) menu_item, _("_Low"));
    gtk_menu_shell_append((GtkMenuShell*) submenu, menu_item);
...
static void
ugtk_menubar_help_init(UgtkMenubar* menubar)
{
    GtkWidget* menu;
    GtkWidget* menu_item;
    ...
    // Get Help Online
    menu_item = gtk_menu_item_new_with_mnemonic(_("Get Help Online"));
    gtk_menu_shell_append((GtkMenuShell*) menu, menu_item);
    menubar->help.help_online = menu_item;

    // Documentation
    menu_item = gtk_menu_item_new_with_mnemonic(_("Documentation"));
    gtk_menu_shell_append((GtkMenuShell*) menu, menu_item);
    menubar->help.documentation = menu_item;

    // Support Forum
    menu_item = gtk_menu_item_new_with_mnemonic(_("Support Forum"));
    gtk_menu_shell_append((GtkMenuShell*) menu, menu_item);
    menubar->help.support_forum = menu_item;

    // Submit Feedback
    menu_item = gtk_menu_item_new_with_mnemonic(_("Submit Feedback"));
    gtk_menu_shell_append((GtkMenuShell*) menu, menu_item);
    menubar->help.submit_feedback = menu_item;

    // Report a Bug
    menu_item = gtk_menu_item_new_with_mnemonic(_("Report a Bug"));
    gtk_menu_shell_append((GtkMenuShell*) menu, menu_item);
    menubar->help.report_bug = menu_item;

    // Keyboard Shortcuts
    menu_item = gtk_menu_item_new_with_mnemonic(_("Keyboard Shortcuts"));
    gtk_menu_shell_append((GtkMenuShell*) menu, menu_item);
    menubar->help.keyboard_shortcuts = menu_item;

    // Check for Updates
    menu_item = gtk_menu_item_new_with_mnemonic(_("Check for Updates"));
    gtk_menu_shell_append((GtkMenuShell*) menu, menu_item);
    menubar->help.check_updates = menu_item;

    // About Uget
    menu_item = gtk_menu_item_new_with_mnemonic(_("About Uget"));
    gtk_menu_shell_append((GtkMenuShell*) menu, menu_item);
    menubar->help.about_uget = menu_item;
}

void
ugtk_menubar_init_ui(UgtkMenubar* menubar, GtkAccelGroup* accel_group)
{
